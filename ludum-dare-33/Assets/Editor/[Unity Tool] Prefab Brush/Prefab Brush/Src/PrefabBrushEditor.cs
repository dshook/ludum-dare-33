...
public class PrefabBrushEditor : EditorWindow
{
    ...
    static string _defaultSaveFilePath = "Assets\\Editor\\[Unity Tool] Prefab Brush\\Data\\SaveData.txt";
    static string _brushSaveFilePath = "Assets\\Editor\\[Unity Tool] Prefab Brush\\Data\\";
    ...
    void OnSceneGUI(SceneView scene_view)
    {
        ...
        //if (result)
        //{
            _brush.pos = ray.origin;
            _brush.surfaceNorm = Vector3.forward;
